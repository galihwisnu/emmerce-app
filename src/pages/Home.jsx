...
class Home extends React.Component {
    ...
    searchBtnHandler = () => {
        const filterProductList = this.state.productList.filter((val) => {
            return val.productName.toLowerCase().includes(this.state.searchProductName.toLocaleLowerCase()) && val.category.toLocaleLowerCase().includes(this.state.searchCategory.toLocaleLowerCase);
        })
